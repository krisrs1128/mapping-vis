...
download still takes time (the file is over 600MB), but it is still
...
thresholds <- c(seq(0.05, 0.90, 0.01), rep(0.90, 10))
...
the test performance on the debris-covered class is superior to the performance
